...
**Markaz to Shopify Converter** — version **1.0.0** (released 2026-09-08).

See [CHANGELOG.md](./CHANGELOG.md) for the full history.

## This release includes

- Standalone Demo Mode with Trends WD favicon, clickable demo account cards, and per-user sandboxes
