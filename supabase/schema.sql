-- Fresh install: Supabase -> SQL Editor -> New query -> paste -> Run
...
-- No policy for anon/public: direct API access is blocked.
-- Streamlit backend should use service_role key in secrets.toml (server-side only).
